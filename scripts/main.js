;(function (window) {
  ...
  let texts = ['TAP ANYWHERE :)','DON'T FORGET', 'TO USE LANDSCAPE MODE', 'HEY', 'TRY TO LOOK AT IT', 'THIS WORD', 'SOMETHING SEEMS WEIRD', 'AYO PENCET LAGI', 'TRY TO PRESS AGAIN', 'PRESS AGAIN', 'I KNOW YOU MUST BE ANXIOUS', 'BUT THIS IS REALLY WEIRD', 'AK', 'INI TERAKHIR KALI', 'PENCET LAGI', 'AYO SEMANGAT', 'KAMU PASTI BISA', 'IHHH KAMU KURANG PENCET ITU', 'AYO DONG', 'IYA INI BENER TERAKHIR KOK', 'YASUDAH DEH', 'I', 'LOVE', 'YOU ♡', 'HAPPY VALENTINE DAY', 'BYE', 'MAAFIN AKU YA', 'KALO AKU BIKIN KAMU SEDIKIT KESAL']
