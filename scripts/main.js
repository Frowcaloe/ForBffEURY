;(function (window) {
  ...
  let texts = ['TAP ANYWHERE :)','DON'T FORGET', 'TO USE LANDSCAPE MODE', 'HEY', 'TRY TO LOOK AT IT', 'THIS WORD', 'SOMETHING SEEMS WEIRD', 'TRY TO PRESS AGAIN', 'I DON'T LIE', 'PRESS AGAIN', 'I KNOW YOU MUST BE ANXIOUS', 'BUT THIS IS REALLY WEIRD', 'I PROMISE', 'THIS IS THE LAST TIME', 'PRESS AGAIN', 'KEEP THE SPIRIT', 'YOU CAN DO IT', 'IHHH YOU'RE LESS TIGHT', 'COME ON DONG', 'THIS IS REALLY THE LAST', 'YES, THAT'S OKAY', 'I', 'LOVE', 'YOU ♡', 'HAPPY VALENTINE DAY', 'BYE', 'I'M SORRY OKAY', 'IF I MAKE YOU A LITTLE ANGRY']
