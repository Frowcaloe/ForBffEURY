;(function (window) {
  ...
  let texts = ['TAP ANYWHERE :)','DO NOT FORGET', 'TO USE LANDSCAPE MODE', 'HEY', 'TRY TO LOOK AT IT', 'THIS WORD', 'SOMETHING SEEMS WEIRD', 'TRY TO PRESS AGAIN', 'I DO NOT LIE', 'PRESS AGAIN', 'I KNOW YOU MUST BE ANXIOUS', 'BUT THIS IS REALLY WEIRD', 'I PROMISE', 'THIS IS THE LAST TIME', 'PRESS AGAIN', 'KEEP THE SPIRIT', 'YOU CAN DO IT', 'IHHH YOU ARE LESS TIGHT', 'COME ON DONG', 'THIS IS REALLY THE LAST', 'YES, THAT IS OKAY', 'I', 'LOVE', 'YOU ♡', 'HAPPY VALENTINE DAY', 'BYE', 'I AM SORRY OKAY', 'IF I MAKE YOU A LITTLE ANGRY']
